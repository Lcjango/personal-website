    ...
    <div className="App">
      ...
      <section id="home" className="hero">
        <div className="hero-content">
          <h1 className="fade-in">你好，我是 [你的名字]</h1>
          <p className="fade-in delay-1">创意设计师 & 开发者</p>
          <p className="fade-in delay-2">专注于视觉设计、前端开发和创意内容创作</p>
          <a href="#portfolio" className="btn fade-in delay-3">查看作品</a>
        </div>
      </section>
      ...
      <section id="contact" className="section contact">
        <h2 className="section-title">取得联系</h2>
        ...
        <form className="contact-form">
          ...
          <button type="submit" className="btn">发送消息</button>
        </form>
      </section>
